...
status: todo
priority: p0
dependencies: [optimized-provider-performance-protocol, cuda-simple-einsum-dispatch-overhead, cuda-view-consumption-overhead, provider-aware-reduction-selection, collapsed-extrema-provider-regression, prepared-diagonal-index-plans, device-calibrated-nary-planner, cpu-zero-k-fixed-overhead]
related: []
scopes: [ticketing]
shared_scopes: []
paths: []
